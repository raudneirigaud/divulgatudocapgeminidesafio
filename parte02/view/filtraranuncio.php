...
if( isset($_POST['cliente']) ){
    $name = mysqli_real_escape_string($con, htmlspecialchars($_POST['cliente']));
    $sql = "SELECT * FROM anuncios WHERE cliente ='$name'";
}
...
<input type="text" id="cliente" name="cliente" class="form-control" placeholder="Digite o nome do cliente" required onfocus>
